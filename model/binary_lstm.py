...
from module.self_attention import BertSelfAttention, SelfAttentive
...
class BinaryLSTMClassifier(nn.Module):
    def __init__(self, emb_dim, hidden_dim, vocab_size, num_label, attention_mode, args):
        ...
        # Init Attention
        if attention_mode == 'bert':
            self.att = BertSelfAttention
        elif attention_mode == 'attentive':
    ...
    def forward(self, x, seq_len, elmo=None):
